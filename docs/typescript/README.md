...
- **[🔧 Setup Guides](_media/DOCUMENTATION.md)** - Documentation infrastructure and setup
- **[📁 Examples](_media/examples)** - Comprehensive code examples and tutorials
- **[🔄 Migration Guide](_media/MIGRATION.md)** - Upgrading from previous versions
...
Version 0.3.0 renames the core dependency from `lightweight-charts-core` to `lightweight-charts-pro`. See [MIGRATION.md](_media/MIGRATION.md) for details on updating your code.
