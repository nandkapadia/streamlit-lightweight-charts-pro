...
import { createBandSeries, type BandData } from '../../plugins/band/bandSeriesPlugin';
import { createRibbonSeries, type RibbonData } from '../../plugins/ribbon/RibbonSeries';
import {
  createGradientRibbonSeries,
  type GradientRibbonData,
} from '../../plugins/gradient-ribbon/GradientRibbonSeries';
import { createSignalSeries, type SignalData } from '../../plugins/signal/SignalSeries';
import { createTrendFillSeries } from '../../plugins/trend-fill/TrendFillSeries';
