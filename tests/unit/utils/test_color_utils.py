...
from streamlit_lightweight_charts_pro.utils.color_utils import (
    add_opacity,
    hex_to_rgba,
    is_hex_color,
)
...
class TestIsHexColor:
    ...
    def test_boundary_cases(self):
        """Test boundary cases."""
        # Exactly 7 characters (including #)
...
class TestColorUtilsIntegration:
    ...
    def test_color_conversion_pipeline(self):
        ...
        # Convert to RGBA with different opacities
        ...
        # Verify all RGBA colors are not hex
