...
class EnhancedTestRunner:
    ...
    def run_tests(
        ...
        cmd = self._build_command(
            category, subcategory, test_file, verbose, coverage,
            html_report, parallel, markers, performance, property_based
        )
...
Examples:
  ...
  python run_tests_enhanced.py --list-categories
    ...
    parser.add_argument(
        "--subcategory",
        help="Unit test subcategory (e.g., data, series, options)"
    )
