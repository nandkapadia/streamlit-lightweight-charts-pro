...
1. **[Tutorial 2: Understanding Data Formats](tutorial_02_data_formats.py)** - Learn
    about different ways to provide data
2. **[Tutorial 3: Customizing Your Chart](tutorial_03_customizing_charts.py)** - Learn about colors,
    styling,
    and options
3. **[Basic Line Chart Example](../line_charts/line_chart_basic.py)** - A more
    detailed line chart example
...
st.markdown("---")
st.markdown(
    "💡 **Tip**: This tutorial is designed to be run with `streamlit run 01_hello_world.py`",
)
