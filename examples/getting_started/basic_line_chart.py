...
def main():
    ...
    with col1:
        ...
        for i, point in enumerate(data[:5]):  # Show first 5 points
    ...
    with col2:
        ...
        st.metric("Price Range", f"${min(d.value for d in data):.1f} - ${max(d.value for d in data):.1f}")
...
""", language="python")
    ...
    **Why this structure?**
    ...
    - **[Chart Customization](../advanced_features/chart_customization.py)** - Colors, styles, and options
