...
def main():
    ...
    chart_options = ChartOptions(
        layout={
            "background": {"type": "solid", "color": background_color},
            "text_color": text_color,
        },
        grid={
            "vert_lines": {"color": "#e6e6e6" if show_grid else "transparent"},
            "horz_lines": {"color": "#e6e6e6" if show_grid else "transparent"},
        },
        crosshair={"mode": 1 if show_crosshair else 0},
        right_price_scale={"border_color": "#cccccc" if show_price_scale else "transparent"},
        time_scale={
...
chart_options = ChartOptions(
    ...
    right_price_scale=dict(
        border_color="#cccccc" if {str(show_price_scale).lower()} else "transparent"
    ),
    time_scale=dict(
