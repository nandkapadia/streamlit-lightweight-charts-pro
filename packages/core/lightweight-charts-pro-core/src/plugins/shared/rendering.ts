 ...
 */
export function priceToCoordinate<T extends keyof import('lightweight-charts').SeriesOptionsMap>(
  price: number,
  series: ISeriesApi<T>
): number | null {
...
export function convertToCoordinates<
  TData extends { time: Time; [key: string]: unknown },
  TSeries extends keyof import('lightweight-charts').SeriesOptionsMap
>(
  items: TData[],
  chart: IChartApi,
